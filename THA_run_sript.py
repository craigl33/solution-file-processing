...
config = sfp.SolutionFilesConfig('config_files/thailand/THA.toml')  # e.g. 'config_archive/vanilla_dev/IDN.toml'
...
# sfp.timeseries.create_output_9(config)
