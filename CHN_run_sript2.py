...
config = sfp.SolutionFilesConfig('config_files/china/CHN2.toml')  # e.g. 'config_archive/vanilla_dev/IDN.toml'
...
# sfp.timeseries.create_output_5(config) # unimplemented
